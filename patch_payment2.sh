              ...
              {paymentMethod === 'upi' && (
                ...
                >
                  ...
                  <div className="bg-[#F5F8EC] border border-[#C9D7B5] rounded-sm p-5 flex flex-col items-center justify-center w-full relative overflow-hidden">
                    ...
                    <div className="w-40 h-40 bg-white border border-[#C9D7B5] p-2.5 rounded-lg flex items-center justify-center shadow-inner relative z-10 mb-4">
                    ...
                    <div className="flex flex-col items-center gap-1.5 z-10">
                      ...
                      <span className="text-[9px] uppercase tracking-widest font-bold text-[#17351F]/60 text-center">
